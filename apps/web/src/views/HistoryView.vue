    ...
    <div class="history-card">
      ...
      <div class="history-actions">
        <n-space>
          ...
          <n-button @click="router.push('/')">返回排盘</n-button>
        </n-space>
      </div>
        ...
        <div v-for="item in history" :key="item.id" class="history-item">
          <div class="history-header">
            ...
            <div class="history-actions-item">
              <n-button size="small" type="primary" @click="handleRestore(item.id)">恢复</n-button>
              <n-button size="small" @click="handleDelete(item.id)">删除</n-button>
            </div>
          </div>

          <div class="history-details">
            <div class="detail-item"><strong>占问：</strong>{{ item.title || '无标题' }}</div>
